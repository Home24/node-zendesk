...
// ====================================== Upload and create a new app package
Apps.prototype.uploadAndCreate = function (file, appOptions, cb) {
    var self = this;

    this.requestUploadApp(['apps', 'uploads'], file, function(err, req, result) {
        if (err) {
            return cb(err);
        }
...
// ====================================== Show installedApp
Apps.prototype.showInstalledApp = function (options, cb) {
    this.request('GET', ['apps', 'installations'], options, cb);
};

// ====================================== Update installedApp
Apps.prototype.updateInstalledApp = function (recordId, options, cb) {
    this.request('PUT', ['apps', 'installations', recordId], options, cb);
};

// ====================================== Show roles
Apps.prototype.showAppRoles = function (cb) {
    this.request('GET', ['apps', 'roles'], cb);
};